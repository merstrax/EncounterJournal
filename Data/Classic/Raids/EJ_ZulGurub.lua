...
high_priest_venoxis = createEncounter();
...
bloodlord_mandokir = createEncounter();
...
cache_of_madness_gri_lek = createEncounter();
...
cache_of_madness_hazza_rah = createEncounter();
...
cache_of_madness_renataki = createEncounter();
...
cache_of_madness_wushoolay = createEncounter();
...
high_priestess_kilnara = createEncounter();
...
jin_do_the_godbreaker = createEncounter();
