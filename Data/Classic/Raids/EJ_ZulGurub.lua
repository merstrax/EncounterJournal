...
high_priest_venoxis = EJ_Data:CreateEncounter();
...
bloodlord_mandokir = EJ_Data:CreateEncounter();
...
cache_of_madness_gri_lek = EJ_Data:CreateEncounter();
...
cache_of_madness_hazza_rah = EJ_Data:CreateEncounter();
...
cache_of_madness_renataki = EJ_Data:CreateEncounter();
...
cache_of_madness_wushoolay = EJ_Data:CreateEncounter();
...
high_priestess_kilnara = EJ_Data:CreateEncounter();
...
zanzil = EJ_Data:CreateEncounter();
...
jin_do_the_godbreaker = EJ_Data:CreateEncounter();
