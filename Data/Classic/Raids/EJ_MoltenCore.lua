...
lucifron:addSection(EJ_Data:CreateSection("Heroic", "This should only show up when Heroic is selected", 0, EJ_Data.IconFlags.Heroic, DifficultyUtil.ID.RaidHeroic), lucifron_phase_1);
lucifron:addSection(EJ_Data:CreateSection("Mythic", "This should only show up when Mythic is selected", 0, EJ_Data.IconFlags.Mythic, DifficultyUtil.ID.RaidMythic), lucifron_phase_1);
lucifron:addSection(EJ_Data:CreateSection("Ascended", "This should only show up when Ascended is selected", 0, EJ_Data.IconFlags.Mythic + EJ_Data.IconFlags.Heroic, DifficultyUtil.ID.RaidAscended), lucifron_phase_1);
