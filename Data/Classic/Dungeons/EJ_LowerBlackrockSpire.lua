...
highlord_omokk:setLoot({13170,13169,13168,13166,13167,12336,12534,16670,}); 
...
shadow_hunter_vosh_gajin:setLoot({12626,13257,13255,12651,12653,12654,13352,12821,16712}); 
...
war_master_voone:setLoot({22231,13179,13177,12582,28972,12335,16676}); 
...
urok_doomhowl:setLoot({13258,22232,13259,13178,18784,12725, 12712,15867}); 
...
quartermaster_zigris:setLoot({13253,13252,12835,12798,21955}); 
...
overlord_wyrmthalak:setLoot({13143,13162,13164,22321,13163,13148,13161,12337,16679}); 
