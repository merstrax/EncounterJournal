...
instance:setAttributes(230, "Dire Maul", EJ_Descriptions.Instances["DIREMAUL"], 429, bgFile, btnFile, loreFile, DifficultyUtil.ID.DungeonMythic);
...
cho_rush_the_observer:setAttributes("Cho'Rush the Observer", "Cho'Rush doesn't usually take sides, but when Ulrok was rising to power, it was clear there was nobody who could challenge him. The king quickly appointed Cho'Rush as his chief advisor, believing that his twin heads would make him twice as resourceful as the average ogre.", 230, 367, 15, 4);
