...
avatar_of_hakkar:setLoot({12462,10843,10842,10846,10845,10838,10844});
...
jammal_an_the_prophet:setLoot({10806,10808,10807,});
...
wardens_of_the_dream:setLoot({12465,12466,12464,10795,10796,10797,12463,12243});
...
EJ_Data:addInstance(EJ_Data.CLASSIC, instance, EJ_Data.Dungeons, 13);