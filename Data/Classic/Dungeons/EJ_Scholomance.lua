...
kirtonos_the_herald:setAttributes("Kirtonos the Herald", "", 0.652879, 0.604144, 246, 1426, 1, 5524, 476, 4);
...
death_knight_darkreaver:setAttributes("Death Knight Darkreaver", "", 0.652879, 0.604144, 246, 14260, 4, 5524, 476, 4);
...
ras_frostwhisper:setAttributes("Ras Frostwhisper", "", 0.652879, 0.604144, 246, 14261, 5, 5524, 476, 4);
...
kormok:setAttributes("Kormok", "", 0.518268, 0.470907, 246, 1429, 6, 5558, 477, 4);
kormok:setLoot({22303,22326,22331,22332,22333}); 
instance:addEncounter(kormok);

local instructor_malicia = EJ_Data:CreateEncounter();
instructor_malicia:setAttributes("Instructor Malicia", "", 0.518268, 0.470907, 246, 14262, 7, 5558, 477, 4);
...
doctor_theolen_krastinov:setAttributes("Doctor Theolen Krastinov", "", 0.518268, 0.470907, 246, 14263, 8, 5558, 477, 4);
...
lorekeeper_polkelt:setAttributes("Lorekeeper Polkelt", "", 0.518268, 0.470907, 246, 14264, 9, 5558, 477, 4);
...
the_ravenian:setAttributes("The Ravenian", "", 0.518268, 0.470907, 246, 14265, 10, 5558, 477, 4);
...
lord_alexei_barov:setAttributes("Lord Alexei Barov", "", 0.518268, 0.470907, 246, 14266, 11, 5558, 477, 4);
...
lady_illucia_barov:setAttributes("Lady Illucia Barov", "", 0.518268, 0.470907, 246, 14267, 12, 5558, 477, 4);
