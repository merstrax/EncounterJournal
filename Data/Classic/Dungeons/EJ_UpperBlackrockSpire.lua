...
pyroguard_emberseer:setAttributes("Pyroguard Emberseer", "", 0.419285, 0.602438, 742, 2420, 1, 0, 229, 4);
...
solakar_flamewreath:setAttributes("Solakar Flamewreath", "", 0.419285, 0.602438, 742, 2421, 2, 0, 229, 4);
...
goraluk_anvilcrack:setAttributes("Goraluk Anvilcrack", "", 0.419285, 0.602438, 742, 2422, 3, 0, 229, 4);
...
warchief_rend_blackhand:setAttributes("Warchief Rend Blackhand", "", 0.419285, 0.602438, 742, 2423, 4, 0, 229, 4);
...
gyth:setAttributes("Gyth", "", 0.419285, 0.602438, 742, 2424, 5, 0, 229, 4);
...
the_beast:setAttributes("The Beast", "", 0.419285, 0.602438, 742, 2425, 6, 0, 229, 4);
...
lord_valthalak:setAttributes("Lord Valthalak", "", 0.419285, 0.602438, 742, 2426, 7, 0, 229, 4);
...
general_drakkisath:setAttributes("General Drakkisath", "", 0.419285, 0.602438, 742, 2427, 8, 0, 229, 4);
