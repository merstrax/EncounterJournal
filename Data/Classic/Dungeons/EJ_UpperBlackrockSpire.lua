...
pyroguard_emberseer:setAttributes("Pyroguard Emberseer", "", 742, 2420, 1, 4);
...
solakar_flamewreath:setAttributes("Solakar Flamewreath", "", 742, 2421, 2, 4);
...
goraluk_anvilcrack:setAttributes("Goraluk Anvilcrack", "", 742, 2422, 3, 4);
...
warchief_rend_blackhand:setAttributes("Warchief Rend Blackhand", "", 742, 2423, 4, 4);
...
gyth:setAttributes("Gyth", "", 742, 2424, 5, 4);
...
the_beast:setAttributes("The Beast", "", 742, 2425, 6, 4);
...
lord_valthalak:setAttributes("Lord Valthalak", "", 742, 2426, 7, 4);
...
general_drakkisath:setAttributes("General Drakkisath", "", 742, 2427, 8, 4);
