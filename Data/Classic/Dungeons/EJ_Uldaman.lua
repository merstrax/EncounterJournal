...
revelosh:setLoot({9390,9389,9388,9387});
...
ironaya:setLoot({9407,9409,9408});
...
ancient_stone_keeper:setLoot({9411,9410});
...
galgann_firehammer:setLoot({11311,11310,9419,9412});
...
grimlok:setLoot({9415,9414,9416});
...
EJ_Data:addInstance(EJ_Data.CLASSIC, instance, EJ_Data.Dungeons, 10);