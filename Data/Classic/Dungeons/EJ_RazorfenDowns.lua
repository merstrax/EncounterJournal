...
tuten_kash:setAttributes("Tuten'kash", "", 0.58982, 0.342815, 233, 1662, 1, 9491, 300, 4);
tuten_kash:setLoot({10776,10777,10775}); 
instance:addEncounter(tuten_kash);

local mordresh_fire_eye = EJ_Data:CreateEncounter();
mordresh_fire_eye:setAttributes("Mordresh Fire Eye", "As a former shaman, Mordresh has exerted his twisted control over the elements.  He burns and scorches all those who threaten Amnennar's work.", 0.860656, 0.467213, 233, 1663, 2, 4767, 300, 2);
mordresh_fire_eye:setLoot({10771,10769,10770});
instance:addEncounter(mordresh_fire_eye); 

local glutton = EJ_Data:CreateEncounter();
glutton:setAttributes("Glutton", "Glutton is a grotesque collection of parts collected from other failed creations.  Full of bile, pus, and other noxious humors, Mushlump contaminates the halls leading to Amnennar the Coldbringer.", 0.34531, 0.664671, 233, 1664, 3, 9496, 300, 4);
glutton:setLoot({10774,10772}); 
instance:addEncounter(glutton); 

local ragglesnout = EJ_Data:CreateEncounter();
ragglesnout:setAttributes("Ragglesnout", "", 0.43014, 0.627246, 233, 1665, 4, 9523, 300, 4);
...
amnennar_the_coldbringer:setAttributes("Amnennar the Coldbringer", "The lich Amnennar was once a force of reckoning within the Scourge, participating in the assault on Mount Hyjal during the Third War. Afterward, the Lich King instructed his servant to remain in Kalimdor and expand the Scourge's influence. This effort was thwarted by heroes of the Horde and Alliance, however. Now the relative peace that has been brought to Razorfen Downs may be threatened.", 0.45509, 0.582335, 233, 1666, 5, 9484, 300, 4);
